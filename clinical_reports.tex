...
and the participant lost voluntary control the left limbs and partially
of the right limbs, but right arm and finger movement were possible, albeit with effort.
\emph{Presentation:} A1 was lying reclined in a hospital bed, the
experimental setup was positioned on a movable folding table.
\emph{Communication:} A1 was anarthric, and communicated using vocal
grunts and a text-to-speech \ac{aac} tablet operated with the right hand.
...
\emph{Presentation:} B1 was seated in an electric wheelchair, which was
...
\emph{Eye movements:} B1 reported impaired visual pursuit of moving targets and
fatigue and discomfort fixating.
Indeed, we noticed effort when making eye movements, which resulted in
large muscular artifacts registered in the \ac{eeg} and \ac{eog}
...
\emph{Eye movements:} B2 was affected by especially severe horizontal eye
...
prior at age 18.
\emph{Presentation:} B4 was a wheelchair user but could stand up and move into
position for the experiment without support.
...
self-reported fatigue and discomfort. Nystagmus. B4 wore no corrective glasses lenses.
...
\emph{Presentation:} C2 was seated in an electric wheelchair controlled by a
...
\emph{Communication:} C2 had complete anarthria and had no preserved facial
movement. He communicated with caregivers by responding to prompted letters and
words with upwards eye movement signals.
...
Deviation in the left eye resulting in diplopia, corrected by a prism lense.
Self-reported tremors and fixation fatigue and discomfort.
Eye tracker calibration did not succeed.
...
\emph{Presentation:} C3 was seated in an electric wheelchair
\emph{Communication:} C3 was completely anarthric, but had sufficient residual
...
When corrected with lenses, downward movement was preserved and incyclotorsion was possible
through preserved cranial nerve IV. Ophthalmoplegia in other directions.
Left eye: limited adduction, complete verticality, horizontal nystagmus.
...
\emph{Communication:} C4 had sufficient residual motor control
to indicate letters and symbols on a letterboard by pointing with
movements of the right index finger and hand.
\emph{Eye movement:}
A corneal abcess in the left eye affected its motility and resulted in deviation.
...
Hypermetropia.
The participant wore corrective lenses.
Eye tracker calibration did not succeed.
